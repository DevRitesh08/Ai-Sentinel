    ...
    <>
      <div className="space-y-3" style={{ animation: "fadeUp 0.35s ease both" }}>
        ...
        <div className="flex justify-end">
          <div className="max-w-[82%] sm:max-w-lg px-4 py-2.5 rounded-2xl rounded-br-md text-[13.5px] text-[#C8D8E8]"
        ...
        <div className="card overflow-hidden" style={{ borderColor: "#182030" }}>
          ...
          {/* Trust header */}
          <div className="flex items-center gap-4 px-5 py-4 border-b border-[#182030]"
            style={{ background: "rgba(8,14,22,0.5)" }}>
              ...
              <div className="flex items-center flex-wrap gap-1.5">
                ...
                {data.verifier_used && (
                  <span className="badge-dual text-[10px]">
                    <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><path d="M9 9h.01M15 9h.01M8 14s1.5 2 4 2 4-2 4-2"/></svg>
                    dual‑LLM
                  </span>
                )}
                {data.from_cache && (
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {totalClaims > 0 && (
                <button onClick={() => setDrawerOpen(true)}
                  ...
                  <span className="hidden sm:inline">{verifiedCount}/{totalClaims}</span>
          ...
          <div className="flex items-center justify-between px-5 py-3 border-t border-[#182030]/60">
            ...
            <button onClick={handleCopy}
              className="btn-ghost text-[11px] rounded-lg px-2.5 py-1 gap-1.5">
              {copied ? (
                <>
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#01C4A0" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
